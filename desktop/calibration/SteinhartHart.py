...
from calibration.formulas import Physical_Unit
...
COEFF_FILE_CSV = 'coefficients.csv'
...
class TemperatureResistance:
    ...
    def __init__(self, T, R):
        """
        Creates an instance of the the TemperatureResistance class
...
class SteinHart:
    """
    Object Oriented representation of the Steinhart-Hart equation
...
if __name__ == '__main__':
    ...
    sth.feed(15, 30)
    print(sth)
    sth.calculate_t(1300)
    
    print('-'*80)
    
    sth.feed(8, 110)
    print(sth)
    print("Calculation (R = %s ) T = %s" % (1300, round(sth.calculate_t(1300), 4)))
